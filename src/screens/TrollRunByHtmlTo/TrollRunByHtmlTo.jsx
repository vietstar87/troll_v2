      ...
      >
            ...
            >
              ...
              >
                ...
                >
                  ...
                  >
                    <div className="link">
                      <div className="text-wrapper-6">Connect</div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              >
                ...
                >
                  <div className="div-elementor-widget-2">
                    ...
                    >
                      {screenWidth >= 1920 && <div className="text-wrapper-7">TROLL</div>}
            ...
            <>
              ...
              >
                ...
                <div className="div-elementor-widget-6">
                  ...
                  >
                    {screenWidth >= 1920 && <div className="text-wrapper-10">ABOUT</div>}
          ...
          {((screenWidth >= 1024 && screenWidth < 1440) || screenWidth < 1024) && (
            ...
            >
              <div
                ...
                style={{
                  height: screenWidth >= 1024 && screenWidth < 1440 ? "78px" : screenWidth < 1024 ? "114px" : undefined,
                  width: screenWidth >= 1024 && screenWidth < 1440 ? "205px" : screenWidth < 1024 ? "195px" : undefined,
                }}
              >
                <div
                  ...
                  style={{
                    height:
                      screenWidth >= 1024 && screenWidth < 1440 ? "54px" : screenWidth < 1024 ? "94px" : undefined,
                    left: screenWidth >= 1024 && screenWidth < 1440 ? "70px" : screenWidth < 1024 ? "41px" : undefined,
                    top: screenWidth >= 1024 && screenWidth < 1440 ? "12px" : screenWidth < 1024 ? "10px" : undefined,
                    width:
                      screenWidth >= 1024 && screenWidth < 1440 ? "65px" : screenWidth < 1024 ? "114px" : undefined,
                  }}
                />
              </div>
              {screenWidth < 1024 && (
              ...
              {screenWidth >= 1024 && screenWidth < 1440 && (
                <>
                  <div className="div-elementor-widget-8">
                    ...
                    <div className="nav-list-item-link-7">
                      <div className="text-wrapper-14">How To Buy</div>
                    </div>
                    <div className="nav-list-item-link-8">
                      <div className="text-wrapper-15">Roadmap</div>
                    </div>
                    <div className="nav-list-item-link-9">
        ...
        >
          {((screenWidth >= 1024 && screenWidth < 1440) || screenWidth < 1024) && (
            ...
            >
              <div
                className="div-elementor-widget-10"
                style={{
                  height:
              ...
              >
                ...
                >
                  {screenWidth >= 1024 && screenWidth < 1440 && (
                    <>
                      <div className="heading-8">
                        <div className="text-wrapper-17">TROLL</div>
                      </div>
                      <div className="heading-9">
                        <div className="text-wrapper-18">Trollface is back</div>
                      </div>
                  ...
                  {screenWidth < 1024 && <div className="text-wrapper-19">TROLL</div>}
                </div>
                {screenWidth < 1024 && (
                  <>
                    ...
                    <div className="div-elementor-widget-12">
                      <div className="link-9">
                        <div className="text-wrapper-20">Buy Now</div>
                      </div>
                    </div>
                  </>
                )}
                ...
                <div className="div-elementor-4">
                  ...
                  <div className="div-elementor-widget-14">
                    <div className="heading-11">
                      <div className="text-wrapper-21">Create a Wallet</div>
                    </div>
                ...
                <div className="div-elementor-4">
                  ...
                  <div className="div-elementor-widget-14">
                    <div className="heading-12">
                      <div className="text-wrapper-22">Get Some BNB</div>
                    </div>
              ...
              >
                <div className="div-elementor-6">
                  ...
                  <div className="div-elementor-widget-17">
                    <div className="heading-12">
                      <div className="text-wrapper-24">Switch BNB for Troll</div>
                    </div>
                ...
                <div className="div-elementor-7">
                  <div className="div-elementor-widget-18">
                    <div className="heading-13">
                      <div className="text-wrapper-25">Token Supply</div>
                    </div>
                    <div className="heading-14">
                      <div className="text-wrapper-26">960,420,000,000,000</div>
                    </div>
                    <div className="heading-15">
                      <div className="text-wrapper-27">Tax: 0%</div>
                    </div>
                    <div className="heading-16">
                      <div className="text-wrapper-28">Liquidity Pool 93.1%</div>
                    </div>
                  </div>
                ...
                >
                  ...
                  <div className="div-elementor-widget-19">
                    <div className="heading-17">
                      <div className="text-wrapper-29">Phase 1: Troll</div>
                    </div>
                    <div className="heading-18">
                      <p className="text-wrapper-30">Phase 2: Troll and HODL</p>
                    </div>
          ...
          <>
            ...
            >
              ...
              >
                ...
                >
                  ...
                  >
                    <div
                      className="go-to-uniswap-wrapper"
                      style={{
                        width:
                          screenWidth < 1024
                            ? "317px"
                    ...
                    >
                      <div
                        className="go-to-uniswap"
                        style={{
                          left:
                            screenWidth < 1024 ? "19px" : screenWidth >= 1024 && screenWidth < 1440 ? "0" : undefined,
                          textAlign: screenWidth < 1024 ? "center" : undefined,
                          width:
                            screenWidth < 1024
                              ? "278px"
                      ...
                      >
                        {screenWidth < 1024 && <>Go to Uniswap</>}

                        {screenWidth >= 1024 && screenWidth < 1440 && <>Go to Pancakeswap</>}
                      </div>
                    </div>
                    <div
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <div
                      className="liquidity-pool-wrapper"
                      style={{
                        height:
                          screenWidth < 1024 ? "50px" : screenWidth >= 1024 && screenWidth < 1440 ? "30px" : undefined,
                        top:
                          screenWidth < 1024
                            ? "165px"
                            : screenWidth >= 1024 && screenWidth < 1440
                    ...
                    >
                      ...
                      >
                        ...
                        {screenWidth >= 1024 && screenWidth < 1440 && <>Liquidity Pool 93.1%</>}
                      </div>
                    </div>
                  </div>
                  <div
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <div
                    className="div-elementor-widget-34"
                    style={{
                      height:
                  ...
                  <div
                    className="div-elementor-widget-35"
                    style={{
                      height:
                        screenWidth < 1024 ? "162px" : screenWidth >= 1024 && screenWidth < 1440 ? "188px" : undefined,
            ...
            >
              ...
              >
                ...
                {screenWidth >= 1024 && screenWidth < 1440 && (
                  <p className="text-wrapper-41">© 2023 by TROLL. All rights reserved!</p>
                )}
              </div>
            </div>
          </>
